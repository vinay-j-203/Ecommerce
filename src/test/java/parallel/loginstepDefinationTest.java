...
public class loginstepDefinationTest extends Base {
	...
	private String invalidUname="The entered password is incorrect";
	...
	public void navigate_to_home_page() throws Throwable {
		...
		Boolean element = wait.until(ExpectedConditions.titleContains(homeTitle));
    ...
    public void error_message_should_be_displayed() throws Throwable {
		Assert.assertTrue(invalidUname.contains("The entered password is incorrect"));
		
    }
	
	@Then("^Forgot link should be displayed$")
    public void forgot_link_should_be_displayed() throws Throwable {
      Assert.assertTrue(hm.getForgot());
      log.info("Forgot pwd link is displayed");
    }
